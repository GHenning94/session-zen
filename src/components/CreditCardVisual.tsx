...
const BrandLogo = ({ brand, className = "h-8" }: { brand: string; className?: string }) => {
  ...
  if (brandLower === 'mastercard') {
    return (
      <svg viewBox="0 0 780 500" className={className} xmlns="http://www.w3.org/2000/svg">
        <circle cx="299" cy="250" r="158" fill="#EB001B"/>
        <circle cx="481" cy="250" r="158" fill="#F79E1B"/>
        <path d="M390 117.3c-48.5 38.5-79.5 98.5-79.5 165.7s31 127.2 79.5 165.7c48.5-38.5 79.5-98.5 79.5-165.7s-31-127.2-79.5-165.7z" fill="#FF5F00"/>
      </svg>
    );
  }
