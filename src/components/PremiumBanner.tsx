...
export const PremiumBanner = ({ shouldShow }: PremiumBannerProps) => {
  ...
  if (isCollapsed) {
    return (
      <Button
        ...
        size="icon"
        data-animate="true"
        className="premium-banner-mini animated-premium w-8 h-8 isolate overflow-hidden rounded-xl p-0 flex items-center justify-center"
  ...
  return (
    <Button
      variant="ghost"
      data-animate="true"
      className="premium-banner animated-premium w-full h-8 isolate overflow-hidden group px-2"
      onClick={handleUpgrade}
    >
