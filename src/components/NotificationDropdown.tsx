      ...
      <>
        <Button variant="ghost" size="icon" className="relative h-9 w-9" onClick={() => setOpen(true)}>
          ...
          {unreadCount > 0 && (
            <Badge 
              variant="destructive" 
              className={`absolute -top-1 -right-1 h-4 w-4 p-0 flex items-center justify-center text-[10px] transition-all duration-300 ${
                incomingNotification ? 'opacity-0 scale-0' : 'opacity-100 scale-100 animate-in zoom-in-50'
              }`}
            >
        ...
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" size="icon" className="relative">
            ...
            {unreadCount > 0 && (
              <Badge 
                variant="destructive" 
                className={`absolute -top-2 -right-2 h-5 w-5 p-0 flex items-center justify-center text-xs transition-all duration-300 ${
                  incomingNotification ? 'opacity-0 scale-0' : 'opacity-100 scale-100 animate-in zoom-in-50'
                }`}
              >
