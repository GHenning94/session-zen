                        ...
                        <div className="flex items-center gap-1">
                          ...
                          {isLocked && (
                            <Badge 
                              ...
                              className="text-[10px] px-1.5 py-0.5 h-5 whitespace-nowrap gap-0.5 min-w-[42px] justify-center"
                            >
                              {isPremiumFeature ? (
                          ...
                          {!isLocked && isComingSoon && (
                            <Badge variant="warning" className="text-[10px] px-1.5 py-0.5 h-5 whitespace-nowrap min-w-[42px] justify-center">
                              Em breve
                            </Badge>
                          )}
                        </div>
