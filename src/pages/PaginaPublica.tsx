...
const PaginaPublica = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const configFields = ['duracao_sessao', 'intervalo_sessoes', 'valor_padrao', 'valor_primeira_consulta', 'aceita_pix', 'aceita_cartao', 'aceita_transferencia', 'aceita_dinheiro', 'chave_pix', 'dados_bancarios', 'email_contato_pacientes', 'whatsapp_contato_pacientes', 'slug', 'page_title', 'page_description', 'brand_color', 'background_color', 'logo_url', 'background_image', 'custom_css', 'custom_footer', 'booking_enabled', 'show_price', 'show_duration', 'show_photo', 'show_specialty', 'show_bio', 'show_session_value', 'show_first_consultation_value', 'show_pix_key', 'show_bank_details', 'show_payment_methods', 'show_page_title', 'show_page_description', 'visual_theme', 'block_order', 'highlight_first_consultation', 'highlight_available_today', 'highlight_promo_value', 'welcome_message', 'show_pre_booking_notes', 'pre_booking_notes', 'cta_button_text', 'trust_badges', 'show_values_after_selection', 'show_starting_from_value', 'emphasize_first_consultation', 'footer_text_color', 'footer_bg_color', 'min_advance_hours', 'max_future_days', 'max_daily_appointments', 'cancellation_policy', 'require_policy_confirmation', 'hide_filled_slots', 'post_booking_message', 'post_booking_redirect', 'post_booking_url', 'public_avatar_url'];
